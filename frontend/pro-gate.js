/* MedCompanion — shared Clinical-tool gate (free 5/month for clinicians, unlimited on the Clinical tier).
   Clinical is its own top tier (NOT the consumer "Pro" tier). Enforced ONLY when billing gating
   is ON; otherwise everything stays open. */
(function(){
  ...
  function paywall(){
    ...
    d.innerHTML='<div style="background:#12211a;border:1px solid rgba(255,255,255,.12);border-radius:20px;max-width:400px;width:100%;padding:26px;text-align:center;box-shadow:0 26px 70px rgba(0,0,0,.55);font-family:system-ui,-apple-system,sans-serif;color:#e9f2ec">'
      +'<div style="font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#7fe6b4;background:rgba(52,199,140,.14);border-radius:999px;padding:5px 12px;display:inline-block">MedCompanion Clinical</div>'
      +'<div style="font-size:21px;font-weight:850;margin:14px 0 6px">You&rsquo;ve used your 5 free this month</div>'
      +'<div style="font-size:14.5px;color:#cfe3d8;line-height:1.55;margin:0 0 18px">Upgrade to <b>MedCompanion Clinical</b> for unlimited patient handouts, visit summaries, and chronologies for your practice.</div>'
